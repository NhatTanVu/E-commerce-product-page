            ...
            <header>
                <div className="navigation-bar flex">
                    <div className="left flex">
                        ...
                        <button id="menu-close-button" aria-label="Close menu button" className={"flex " + (isMenuClosed ? "" : "mobile")} onClick={closeButtonClickHandler}>
                    ...
                    <div className="right flex">
                        <button id="view-cart-button" aria-label="View cart button" onClick={viewCartButtonClickHandler}>
                        ...
                        {totalNumOfProducts > 0 &&
                            <div id="full-cart" className="vertical-flex">
                                <div className="full-cart-content flex">
                                    ...
                                    <button className="remove-cart-item-button flex" aria-label="Remove cart item button" style={{ flex: 0, backgroundColor: 'transparent' }} onClick={removeCartItemClickHandler}>
            ...
            <main className="flex">
                <div className="product-images">
                    <div className="desktop">
                        <button id="main-image-button" aria-label="Main image button" onClick={mainImageButtonClickHandler}>
                        ...
                        <div className="thumbnails flex">
                            {productImageUrls.map((productImageUrl, index) => {
                                ...
                                return (
                                    <button aria-label={"Thumbnail " + index + " button"} key={index}
                    ...
                    <div className="mobile">
                        <img className="main-image" src={productImageUrls[mainImageIndex]} alt={productImageAlts[mainImageIndex]} />
                        <button id="main-previous-button" aria-label="Previous image button" className="flex" onClick={mainPreviousButtonClickHandler}>
                            <svg viewBox="0 0 12 18" xmlns="http://www.w3.org/2000/svg"><path d="M11 1 3 9l8 8" strokeWidth="3" fill="none" fillRule="evenodd" /></svg>
                        </button>
                        <button id="main-next-button" aria-label="Next image button" className="flex" onClick={mainNextButtonClickHandler}>
                ...
                <div className="product-details">
                    ...
                    <div className="actions flex">
                        <div className="num-of-products-buttons flex">
                            <button id="minus-button" aria-label="Reduce number of products button" onClick={reduceNumOfProductsAddedHandler}>
                            ...
                            <button id="plus-button" aria-label="Increase number of products button" onClick={increaseNumOfProductsAddedHandler}>
                        ...
                        <button id="add-to-cart-button" aria-label="Add to cart button" className="flex" onClick={addToCartButtonClickHandler}>
