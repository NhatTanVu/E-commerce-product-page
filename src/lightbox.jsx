        ...
        return (
            <div id="lightbox">
                ...
                <div className="content">
                    ...
                    <button id="close-button" aria-label="Close lightbox button" className="flex" onClick={this.handleClose}>
                    ...
                    <button id="lightbox-previous-button" aria-label="Previous lightbox image button" className="flex" onClick={this.handlePrevious}>
                        <svg viewBox="0 0 12 18" xmlns="http://www.w3.org/2000/svg"><path d="M11 1 3 9l8 8" strokeWidth="3" fill="none" fillRule="evenodd" /></svg>
                    </button>
                    <button id="lightbox-next-button" aria-label="Next lightbox image button" className="flex" onClick={this.handleNext}>
